"""
Django settings for soccer_bot project.
...
SECRET_KEY = 'django-insecure-^eslp)u=96w)vc!s6_2zcdu74&r(!ui*f0rx_7grkg@__ep5uy'
...
WSGI_APPLICATION = 'soccer_bot.wsgi.default.application'
